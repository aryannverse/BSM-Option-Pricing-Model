...
st.set_page_config(
    page_title="BSM Option Pricing Model",
    page_icon="📊",
    layout="wide",
...
with st.sidebar:
    st.title("📊 BSM Model")
    st.write("`Created by:`")
    linkedin_url = "https://www.linkedin.com/in/aryannnnverma/"
    st.markdown(f'<a href="{linkedin_url}" target="_blank" style="text-decoration: none; color: inherit;"><img src="https://cdn-icons-png.flaticon.com/512/174/174857.png" width="25" height="25" style="vertical-align: middle; margin-right: 10px;">`Aryan Verma`</a>', unsafe_allow_html=True)
...
st.info("Explore how option prices change with different levels of Spot Price and Volatility using an interactive heatmap, while keeping the Strike Price fixed.")
